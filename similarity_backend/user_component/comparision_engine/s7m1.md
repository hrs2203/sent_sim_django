...
<img src="./images/SBERT-ARCHI.png" />

we make use of <b>Regression Objective Function (ROF)</b> . In ROF The cosine-similarity between the two sentence embeddingsuandvis  computed  (Figure  2).   We  use  mean-squared-error loss as the objective function.

## Siemese Network for training
